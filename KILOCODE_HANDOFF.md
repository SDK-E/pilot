...
- Worker creation and read-only configuration page. A conversation UUID is reserved as the future Mastra thread ID; conversations are not visible or runnable yet.
