...
const styles = StyleSheet.create({
  ...
  sourceBox: {
    ...
    border: "1 solid #d8e8dd",
    borderRadius: 4,
    marginTop: 10,
    padding: 9,
  },
  sourceTitle: { color: "#007c41", fontFamily: "Helvetica-Bold", fontSize: 9 },
      ...
      <Page size="A4" style={styles.page}>
        ...
        {messages.map((message) => (
          <View key={message.id} style={styles.message} wrap>
            ...
            {researchExportBlocks(message.content).map((block, index) => (
              <Text
